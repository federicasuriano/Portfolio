...
CREATE TABLE `campagna` (
  `CampagnaID` int(11) NOT NULL AUTO_INCREMENT,
  `Nome` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `Committente` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `Stato` int(11) NOT NULL,
  `Manager` int(11) NOT NULL,
  PRIMARY KEY (`CampagnaID`)
...
-- Dump completed on 2019-10-21  9:00:05
