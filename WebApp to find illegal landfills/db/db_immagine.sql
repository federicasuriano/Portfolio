...
CREATE TABLE `immagine` (
  `ImmagineID` int(11) NOT NULL AUTO_INCREMENT,
  `Data` date NOT NULL,
  `Risoluzione` int(11) NOT NULL,
  `Provenienza` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `Localita` int(11) NOT NULL,
...
-- Dump completed on 2019-10-21  9:00:02
