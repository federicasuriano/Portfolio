...
@WebServlet("/scegliCampagna")
@MultipartConfig
public class SceltaCampagna extends HttpServlet {
...
catch( SQLException se )
{
	...
	public void doGet (HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		Lavoratore lavoratore=(Lavoratore) session.getAttribute("utenteCorrente");
		int lavoratoreID= lavoratore.getLavoratoreID();
		//creo campagnaDAO
		CampagnaDAO campagnaDAO = new CampagnaDAO(connection);
		boolean modificato=false;
		//scelgo la campagna
		try {
			modificato=campagnaDAO.scegliCampagna(campagnaID, lavoratoreID);
