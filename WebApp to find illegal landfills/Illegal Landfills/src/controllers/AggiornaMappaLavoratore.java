...
@WebServlet("/aggiornaMappaLavoratore")
@MultipartConfig
public class AggiornaMappaLavoratore extends HttpServlet {
	...
	public void doGet (HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if(localita!=null) {
			...
			if (req.getParameter("aggiunta").equals("0"))	{	req.setAttribute("erroreRegistrazioneAnnotazione","C'è stato un errore nella registrazione! Controlla i dati inseriti."); }
